...
{
    public interface IPeliculasDependenciesMongo
    {
    ...
    {
        private readonly IPeliculasDependenciesMongo _dependencies;
        private readonly ILogger<PeliculasService> _log;

        public PeliculasService(IPeliculasDependenciesMongo dependencies, ILogger<PeliculasService> log)
        {
