...
{
    public interface ISeriesDependenciesMongo
    {
    ...
    {
        private readonly ISeriesDependenciesMongo _dependencies;
        private readonly ILogger<SeriesService> _log;

        public SeriesService(ISeriesDependenciesMongo dependencies, ILogger<SeriesService> logs)
        {
            _dependencies = dependencies;
            _log = logs;
        }

        public SeriesService(ISeriesDependenciesMongo dependencies)
        {
            _dependencies = dependencies;
        }
